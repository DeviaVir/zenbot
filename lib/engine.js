  ...
  return function (s) {
    ...
    function calcBalanceStop(trade,cOrderType,cBalance,cAction,cStopable=null){
      ...
      if (so.mode === 'live' || 
        ...
        (cBalance === 'substract' && trade.price >= s[cOrderType+'_order'].price) 
      ) {
        ...
        delete s[cOrderType+'_order']
        delete s[cOrderType+'_stop']
        if(cStopable!==null)delete s[cStopable+'_stop']
    ...
    function executeOrder (trade) {
      ...
      if(s.short_order){
        calcBalanceStop(trade,'short','add','shorted','close');
      }else if (s.buy_order) {
        ...
        calcBalanceStop(trade,'close','subtract','closed');
      }
    }
