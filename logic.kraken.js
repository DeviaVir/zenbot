// This is based on code in https://github.com/carlos8f/zenbot/issues/9
//    Tobias Abenius
var first_run = true
var last_balance_sig
var sync_start_balance = false
//var sync_start_balance = true
...
// Put your credentials in credentials.js
const kraken_key = c.kraken_key;
const kraken_secret = c.kraken_secret;
...
//        rs.start_balance = rs.sim_start_balance
        ...
        if (get('command') === 'sim') {
          rs.start_balance = rs.sim_start_balance // tabenius: I moved this line to here
