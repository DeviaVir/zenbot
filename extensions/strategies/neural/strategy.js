...
module.exports = function container (get, set, clear) {
  return {
    ...
    onReport: function (s) {
      cols = []
      cols.push(z(8, n(global.mean).format('00000.0'), ' ')[global.meanp > global.mean ? 'green' : 'red'])
      cols.push(z(8, n(global.meanp).format('00000.0'), ' ')[global.meanp > global.mean ? 'green' : 'red'])
      return cols
    },
  }
}
