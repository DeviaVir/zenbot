...
sudo ./zenbot.sh sim --period=100ms --meas=300 --min_periods=250 --strategy=speed --days=0.1 gdax.LTC-USD
sudo ./zenbot.sh sim --period=100ms --meas=400 --min_periods=250 --strategy=speed --days=0.1 gdax.LTC-USD
sudo ./zenbot.sh sim --period=100ms --meas=500 --min_periods=250 --strategy=speed --days=0.1 gdax.LTC-USD
sudo ./zenbot.sh sim --period=100ms --meas=600 --min_periods=250 --strategy=speed --days=0.1 gdax.LTC-USD
sudo ./zenbot.sh sim --period=100ms --meas=700 --min_periods=250 --strategy=speed --days=0.1 gdax.LTC-USD
sudo ./zenbot.sh sim --period=100ms --meas=800 --min_periods=250 --strategy=speed --days=0.1 gdax.LTC-USD
sudo ./zenbot.sh sim --period=100ms --meas=900 --min_periods=250 --strategy=speed --days=0.1 gdax.LTC-USD
sudo ./zenbot.sh sim --period=100ms --meas=1000 --min_periods=250 --strategy=speed --days=0.1 gdax.LTC-USD
sudo ./zenbot.sh sim --period=100ms --meas=1100 --min_periods=250 --strategy=speed --days=0.1 gdax.LTC-USD
sudo ./zenbot.sh sim --period=100ms --meas=1200 --min_periods=250 --strategy=speed --days=0.1 gdax.LTC-USD
sudo ./zenbot.sh sim --period=100ms --meas=1300 --min_periods=250 --strategy=speed --days=0.1 gdax.LTC-USD
sudo ./zenbot.sh sim --period=100ms --meas=1400 --min_periods=250 --strategy=speed --days=0.1 gdax.LTC-USD
sudo ./zenbot.sh sim --period=100ms --meas=1500 --min_periods=250 --strategy=speed --days=0.1 gdax.LTC-USD
sudo ./zenbot.sh sim --period=100ms --meas=1600 --min_periods=250 --strategy=speed --days=0.1 gdax.LTC-USD
sudo ./zenbot.sh sim --period=100ms --meas=1700 --min_periods=250 --strategy=speed --days=0.1 gdax.LTC-USD
sudo ./zenbot.sh sim --period=100ms --meas=1800 --min_periods=250 --strategy=speed --days=0.1 gdax.LTC-USD
sudo ./zenbot.sh sim --period=100ms --meas=1900 --min_periods=250 --strategy=speed --days=0.1 gdax.LTC-USD
sudo ./zenbot.sh sim --period=100ms --meas=2000 --min_periods=250 --strategy=speed --days=0.1 gdax.LTC-USD
sudo ./zenbot.sh sim --period=100ms --meas=2100 --min_periods=250 --strategy=speed --days=0.1 gdax.LTC-USD
sudo ./zenbot.sh sim --period=100ms --meas=2200 --min_periods=250 --strategy=speed --days=0.1 gdax.LTC-USD
sudo ./zenbot.sh sim --period=100ms --meas=2300 --min_periods=250 --strategy=speed --days=0.1 gdax.LTC-USD
sudo ./zenbot.sh sim --period=100ms --meas=2400 --min_periods=250 --strategy=speed --days=0.1 gdax.LTC-USD
sudo ./zenbot.sh sim --period=100ms --meas=2500 --min_periods=250 --strategy=speed --days=0.1 gdax.LTC-USD
sudo ./zenbot.sh sim --period=100ms --meas=2600 --min_periods=250 --strategy=speed --days=0.1 gdax.LTC-USD
sudo ./zenbot.sh sim --period=100ms --meas=2700 --min_periods=250 --strategy=speed --days=0.1 gdax.LTC-USD
sudo ./zenbot.sh sim --period=100ms --meas=2800 --min_periods=250 --strategy=speed --days=0.1 gdax.LTC-USD
sudo ./zenbot.sh sim --period=100ms --meas=2900 --min_periods=250 --strategy=speed --days=0.1 gdax.LTC-USD
sudo ./zenbot.sh sim --period=100ms --meas=3000 --min_periods=250 --strategy=speed --days=0.1 gdax.LTC-USD
        break
    fi
done
