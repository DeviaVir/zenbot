...
export default {
  ...
  getOptions: function() {
    ...
    this.option(
      'kc_upper_channel_pct',
      'pct the current price should be near the keltner upper channel before we sell',
      Number,
      0
    )
    this.option(
      'kc_lower_channel_pct',
      'pct the current price should be near the keltner lower channel before we buy',
      Number,
      0
    )
  },
