...
module.exports = function container (get, set, clear) {
  ...
  return function reporter (tick, cb) {
    ...
    get('logger').info(slug, tick_str, z(7, tick.trades.trades, ' '), n(tick.trades.vol).format('0.000').white, n(tick.trades.typical).format('0.00').yellow, c.currency.grey, 'RSI:'.grey + rs.rsi[c.brain_speed].ansi)
    cb()
  }
}