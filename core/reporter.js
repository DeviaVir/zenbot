...
module.exports = function container (get, set, clear) {
  ...
  return function reporter (tick, cb) {
    ...
    get('logger').info('reporter', tick_str, String(tick.trades.trades).grey, n(tick.trades.vol).format('0.000').white, n(tick.trades.avg_price).format('0.00').yellow, c.currency.grey)
    cb()
  }
}